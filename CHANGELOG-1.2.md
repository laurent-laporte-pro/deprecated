...
The package must be published on PyPi using [twine](https://pypi.org/project/twine/) to correctly deal with the license file.
...
- Fix #79: Fix the configuration for the intersphinx mapping in the Sphinx documentation.
  See [How to link to other documentation projects with Intersphinx](https://docs.readthedocs.io/en/stable/guides/intersphinx.html).
...
- Fix #45: Change the signature of the [`deprecated()`](https://deprecated.readthedocs.io/en/latest/api.html#deprecated.sphinx.deprecated) decorator to reflect
  the valid use cases.
...
- Migrating project to [travis-ci.com](https://www.travis-ci.com/github/tantale/deprecated).
...
- Fix #41: [`deprecated.sphinx`](https://deprecated.readthedocs.io/en/latest/api.html#module-deprecated.sphinx): strip Sphinx cross-referencing syntax from warning message.
...
- Fix #33: Change the class [`SphinxAdapter`](https://deprecated.readthedocs.io/en/latest/api.html#deprecated.sphinx.SphinxAdapter):
...
- Replace `bumpversion` by [bump2version](https://pypi.org/project/bump2version/) in `setup.py` and documentation.
...
- Fix #20: Set the [`warnings.warn()`](https://docs.python.org/3/library/warnings.html#warnings.warn) stacklevel to 2 if the Python implementation is [PyPy](https://pypy.org/).
...
- Fix #15: The `@deprecated` decorator doesn't set a warning filter if the *action* keyword argument is
  ...
  For more information, see [The Warning Filter](https://docs.python.org/3/library/warnings.html#the-warnings-filter)
...
- The [API](https://deprecated.readthedocs.io/en/latest/api.html) documentation and the [Tutorial](https://deprecated.readthedocs.io/en/latest/tutorial.html) is improved to explain how to use
...
- Add a detailed documentation about [The “Sphinx” decorators](https://deprecated.readthedocs.io/en/latest/sphinx_deco.html).
...
- Add [Black](https://black.readthedocs.io/en/latest/) configuration file.
...
- Fix #4: Correct the class [`ClassicAdapter`](https://deprecated.readthedocs.io/en/latest/api.html#deprecated.classic.ClassicAdapter):
  Don't pass arguments to [`object.__new__()`](https://docs.python.org/3/reference/datamodel.html#object.__new__) (other than *cls*).

### Other

- Add missing docstring to the classes [`ClassicAdapter`](https://deprecated.readthedocs.io/en/latest/api.html#deprecated.classic.ClassicAdapter)
  and [`SphinxAdapter`](https://deprecated.readthedocs.io/en/latest/api.html#deprecated.sphinx.SphinxAdapter).
...
- Minor fix: add missing documentation in [`deprecated.sphinx`](https://deprecated.readthedocs.io/en/latest/api.html#module-deprecated.sphinx) module.
