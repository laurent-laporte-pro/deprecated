...
The easiest way to build your API documentation is to use the [autodoc] plugin.
...
For instance, you can configure a documentation environment with [Hatch]
...
[Deprecated-Demo.Sphinx](https://github.com/tantale/deprecated-demo.sphinx).
:::
